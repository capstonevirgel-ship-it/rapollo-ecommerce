...
@section('title', 'Order Completed - Rapollo')

@section('header')
    <div style="font-size:30px; font-weight:800; text-transform:uppercase; letter-spacing:0.18em; color:#f4f4f5;">RAPOLLO</div>
    <div style="margin-top:12px; font-size:15px; font-weight:500; color:#d4d4d8; letter-spacing:0.04em;">Order Completed</div>
@endsection
...
@section('content')
    ...
    <p style="margin:0 0 28px 0; font-size:15px; color:#4b5563;">
        Thank you for confirming receipt! Your order #{{ $purchase->id }} has been marked as completed.
    </p>
    ...
    <p style="margin:0 0 28px 0; font-size:15px; color:#4b5563;">
        We hope you're happy with your purchase! If you have any feedback or need assistance, please don't hesitate to reach out to us.
    </p>
@endsection
