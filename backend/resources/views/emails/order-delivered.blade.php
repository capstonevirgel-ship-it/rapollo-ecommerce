...
@section('title', 'Order Delivered - Rapollo')

@section('header')
    <div style="font-size:30px; font-weight:800; text-transform:uppercase; letter-spacing:0.18em; color:#f4f4f5;">RAPOLLO</div>
    <div style="margin-top:12px; font-size:15px; font-weight:500; color:#d4d4d8; letter-spacing:0.04em;">Order Delivered</div>
@endsection
...
@section('content')
    ...
    <p style="margin:0 0 28px 0; font-size:15px; color:#4b5563;">
        Great news! Your order #{{ $purchase->id }} has been delivered to your address.
    </p>
    ...
    <p style="margin:0 0 28px 0; font-size:15px; color:#4b5563;">
        Please check your package and confirm receipt. Once you've received your order, you can mark it as received from your account to complete the order.
    </p>
@endsection
