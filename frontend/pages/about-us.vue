<template>
  <div class="min-h-screen bg-white">
    ...
    <!-- CTA Section -->
    <div class="py-16 bg-zinc-900 text-white">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl font-bold mb-6">Ready to Start Shopping?</h2>
        <p class="text-xl text-gray-300 mb-8">
          Discover our amazing collection of products and experience the Rapollo difference
        </p>
        <NuxtLink 
          to="/shop" 
          class="inline-flex items-center px-8 py-3 bg-white text-zinc-900 font-semibold rounded-lg hover:bg-gray-100 transition-colors"
        >
          Shop Now
