...
const previewEvent = computed(() => {
  ...
  return {
    ...
    poster_url: posterPreview.value || null,
...
const createEvent = async () => {
  ...
  try {
    ...
    error('Failed to create event', err.data?.message || 'Please try again')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Create New Event</h1>
            <p class="text-sm sm:text-base text-gray-600 mt-1">Fill in the details below to create a new event</p>
          </div>
          <NuxtLink
            to="/admin/events"
        ...
        <div class="space-y-6">
          <form @submit.prevent="createEvent" class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div class="space-y-4">
                <!-- Image Preview -->
                <div v-if="posterPreview" class="w-full h-48 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden border-2 border-gray-200">
                  <img 
                    :src="posterPreview" 
            ...
            <div class="flex justify-end">
              ...
              >
                {{ (isSubmitting || isUploadingImage) ? 'Creating...' : 'Create Event' }}
              </button>
            </div>
          </form>
        </div>
